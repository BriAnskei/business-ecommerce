  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center text-amber-900 dropdown-toggle 
        dark:text-amber-100"
      >
        <span className="mr-3 rounded-full h-11 w-11 bg-gradient-to-br from-amber-700 to-amber-900 flex items-center justify-center shadow-md">
          <svg
        ...
        <svg
          className={`stroke-amber-700 dark:stroke-amber-300 transition-transform
      ...
      >
        <div>
          <span
            className="block font-medium text-gray-700 text-theme-sm 
          dark:text-gray-400"
          >
            Musharof Chowdhury
          </span>
          <span
            className="mt-0.5 block text-theme-xs text-gray-500 
          dark:text-gray-400"
          >
        ...
        >
          <li>
            <DropdownItem
              ...
              text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 
