...
import { FormData } from "../../hooks/auth/autTypes";
    ...
    <>
      <div>
        ...
        <div className="relative">
          <input
            ...
            dark:border-amber-800 bg-white dark:bg-gray-800 py-3 pl-11 pr-4
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-lg border-2 border-amber-200 dark:border-amber-800
             bg-white dark:bg-gray-800 py-3 pl-11 pr-11 text-gray-900 dark:text-white
              placeholder:text-amber-400 dark:placeholder:text-amber-600 outline-none
      ...
      <div className="flex items-center justify-between text-sm">
        <label className="flex cursor-pointer items-center group">
          ...
          group-hover:text-amber-700 dark:group-hover:text-amber-200 transition-colors"
          >
            Remember me
          </span>
        </label>
